...
import {UnitCatalog} from "@/features/unit_catalog/unitCatalog";
import {Company} from "@/features/company_info/Company";
import {Counter} from "@/features/counter/Counter";
import {Guide} from "@/features/guide/Guide";
import {Header} from "@/features/header/Header";
import {Search} from "@/features/search/Search";
import {AddNewUnit} from "@/features/addNewUnit/AddNewUnit";
    ...
    return (
        <div className={`${style.inventorContainer}`}>
            ...
            <div className={style.listsMenu}>
                <NavLink to={'/unit_catalog'}>UNIT CATALOG</NavLink>
            ...
            <Routes>
                ...
                <Route path={'/unit_catalog'} element={<UnitCatalog/>}/>
